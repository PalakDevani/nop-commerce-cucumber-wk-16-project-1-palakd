Feature: Register page
  ...
  Scenario: Verify that user should create account successfully
    ...
    And I enter firstname "Daya"
    And I enter lastname "Patel"
    And I select date of birth "20","Mar","1985"
    And I enter email "daya1985@gmail.com"
    And I enter password "daya123"
    And I enter confirm password "daya123"
    And I click on register button
